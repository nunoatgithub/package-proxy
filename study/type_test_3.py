...
print("*" * 200)
print(f"-> declaring new class B, derived from A ")
class B(A):
    def method_x(self):
        print(f"B.__method_x()")

print("*" * 200)
print("-> printing dictionary attr of this new derived class")
try:
    print("\n".join([str(t) for t in B.__dict__.items()]))
except AttributeError as e:
    print(str(e))

print("*" * 200)
print("-> printing all methods labeled as abstract in this class")
print("\n".join([m.__name__ for k,m in B.__dict__.items() if callable(m) and getattr(m, "__isabstractmethod__", False)]))
...
print("*" * 200)
print(f"-> creating object of new derived class ")
myClassB_obj = B()
print(myClassB_obj)
...
try:
    print("\n".join([str(t) for t in myClassB_obj.__dict__.items()]))
except AttributeError as e:
    print(str(e))
...
print("*" * 200)
print("-> printing all methods labeled as abstract in this class")
print("\n".join([m.__name__ for k,m in MyClassA.__dict__.items() if callable(m) and getattr(m, "__isabstractmethod__", False)]))
print("\n-> printing new class __mro__")
print(MyClassA.__mro__)
print(f"\n-> printing new class __name__ attr")
print(MyClassA.__name__)

print("*" * 200)
print(f"-> declaring new class B, derived from custom class ")
class C(MyClassA):
    def method_x(self):
        print(f"C.__method_x()")

print("*" * 200)
print("-> printing dictionary attr of this new derived class")
try:
    print("\n".join([str(t) for t in C.__dict__.items()]))
except AttributeError as e:
    print(str(e))

print("*" * 200)
print("-> printing all methods labeled as abstract in this class")
print("\n".join([m.__name__ for k,m in C.__dict__.items() if callable(m) and getattr(m, "__isabstractmethod__", False)]))
print("\n-> printing new class __mro__")
print(C.__mro__)
print(f"\n-> printing new class __name__ attr")
print(C.__name__)
...
print("-> printing its dictionary attr")
try:
    print("\n".join([str(t) for t in myClassC_obj.__dict__.items()]))
except AttributeError as e:
    print(str(e))
...
print(f"-> calling method from abstract class ")
try:
    myClassC_obj.method_y()
except AttributeError as e:
    print(str(e))

print("*" * 200)
print("-> issubclass(C, MyClassA)")
print(issubclass(C, MyClassA))
print("*" * 200)
print("MyClassA.__subclasshook__()")
print(MyClassA.__subclasshook__())